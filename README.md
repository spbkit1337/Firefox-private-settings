...
Мои настройки Firefox. Отключена реклама , спонсоры и телеметрия + настроен скролл.Плюс мои расширения чтобы не тратить время на установку после добавления файлов они сами установятся.
